...
// assertEquals(new Double(36.056799999999996), new Double(cout.getReductionHT()));
//
...
// assertEquals(new Double(26.752), cout.getDetails().get(0).getReductionHT());
//
// assertEquals(new Double(34.9), new Double(cout.getDetails().get(0).getCoutRecurrent().getNormal().getTarifHT()));
