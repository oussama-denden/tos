...
public class DatabaseExportUtil {
	...
	protected DatabaseExportUtil() {
		...
		try {
			...
			jdbcConnection = DriverManager.getConnection("jdbc:mysql://localhost:3306/opale_test", "test", "test");
	...
	protected void exportDatabaseToDtd() throws IOException, SQLException, DatabaseUnitException {
		// database connection
		IDatabaseConnection connection = new DatabaseConnection(jdbcConnection);

		// write DTD file
		FlatDtdDataSet.write(connection.createDataSet(), new FileOutputStream("src/test/resources/dtd/opale.dtd"));
	 ...
	 *             if error occurs
	 */
	protected void exportDatabaseToSql(final Dialect dialect, final String packageName)
