...
public interface ReductionRepository extends JpaRepository<Reduction, Integer> {
	 ...
	 * @return {@link List}
	 */
	@Query(name = "findReductionDraft", value = "SELECT r FROM Reduction r WHERE r.referenceLigne=null AND r.referenceLigneDetail=null AND referenceDraft LIKE :referenceDraft ")
	public Reduction findReductionDraft(@Param("referenceDraft") String referenceDraft);
	 ...
	 * @return {@link List}
	 */
	@Query(name = "findReductionLigne", value = "SELECT r FROM Reduction r WHERE   r.referenceLigneDetail=null AND referenceDraft LIKE :referenceDraft  AND r.referenceLigne LIKE :referenceLigne")
	 ...
	 * @return {@link List}
	 */
	@Query(name = "findReductionLigneDetaille", value = "SELECT r FROM Reduction r WHERE referenceDraft LIKE :referenceDraft  AND r.referenceLigne LIKE :referenceLigne AND r.referenceLigneDetail LIKE :referenceLigneDetail ")
	...
	public Reduction findReductionLigneSanFrais(@Param("referenceDraft") String referenceDraft,
			@Param("referenceLigne") String referenceLigne);
	...
	public Reduction findReductionLigneDetailleSansFrais(@Param("referenceDraft") String referenceDraft,
			@Param("referenceLigne") String referenceLigne, @Param("referenceLigneDetail") String referenceLigneDetail);
	...
	public Reduction findReductionLigneFrais(@Param("referenceDraft") String referenceDraft,
	...
	public Reduction findReductionLigneDetailleFrais(@Param("referenceDraft") String referenceDraft,
			@Param("referenceLigne") String referenceLigne, @Param("referenceLigneDetail") String referenceLigneDetail,
	 ...
	 * @return {@link List}
	 */
	@Query(name = "findReductionLigneFrais", value = "SELECT r FROM Reduction r WHERE  r.referenceFrais=null AND r.referenceLigneDetail=null  AND referenceDraft LIKE :referenceDraft  AND r.referenceLigne LIKE :referenceLigne AND r.referenceTarif LIKE :referenceTarif  ")
	public Reduction findReductionECParent(@Param("referenceDraft") String referenceDraft,
			@Param("referenceLigne") String referenceLigne, @Param("referenceTarif") String referenceTarif);
