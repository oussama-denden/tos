package com.nordnet.opale.signature.test.utils;
 ...
 * @author ngendron
 */
public class OpaleMultiSchemaXmlDataSetFactory extends MultiSchemaXmlDataSetFactory {
	...
	public MultiSchemaDataSet createDataSet(File... dataSetFiles) {
		...
		if (multiSchemaDataSet != null && multiSchemaDataSet.getSchemaNames() != null
			...
			for (String schemaName : multiSchemaDataSet.getSchemaNames()) {
				...
				now6.set(Calendar.HOUR_OF_DAY, 0);
