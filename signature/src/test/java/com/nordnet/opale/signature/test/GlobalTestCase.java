package com.nordnet.opale.signature.test;
...
import com.nordnet.opale.signature.util.spring.ApplicationContextHolder;
...
public abstract class GlobalTestCase extends UnitilsJUnit4 {
	...
	public void init() {
		...
		System.setProperty(com.nordnet.opale.signature.util.Constants.ENV_PROPERTY, "dev");
